...
const Navbar = () => (
  <header className="fixed bottom-6 right-5">
    <button
      ...
      className="h-[3.13rem] w-[3.13rem] rounded-md bg-white drop-shadow-2xl"
    >
      <HamburgerSVG className="mx-auto h-8 w-10 fill-sky-400" />
    </button>

    <nav>
      <menu className="grid h-[9.4rem] w-[13.13rem] grid-cols-3 place-items-center rounded-md bg-white p-2 text-xs font-bold text-slate-400 drop-shadow-2xl">
        {[
