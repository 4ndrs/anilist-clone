...
const Hero = () => (
  <section className="mb-[4.4rem] w-full bg-slate-900 px-10 pb-[1.9rem] pt-[4.4rem] text-slate-100">
    ...
    <p className="mx-auto max-w-[25.13rem] text-center text-[1.32rem] font-medium leading-7 text-blue-300">
    ...
    <ul className="mx-auto mb-[5.63rem] mt-[4.4rem] grid max-w-lg grid-flow-row gap-y-14">
      {features.map((feature) => (
        ...
        >
          ...
          />
          <h2 className="mb-2 text-[1.13rem] font-semibold leading-6 text-slate-100">
            {feature.title}
          </h2>
