...
const Hero = () => (
  <section className="relative mb-[4.4rem] w-full bg-slate-900 px-[1.88rem] py-[4.38rem] text-slate-100 lg:mx-auto lg:mt-[3.13rem] lg:max-w-[68.75rem] lg:rounded-[1.25rem] lg:px-20 lg:py-[3.75rem]">
    ...
    <Link
      href="#"
      className="absolute bottom-0 right-1/2 flex h-[3.07rem] w-[12.5rem] translate-x-1/2 translate-y-1/2 items-center justify-center rounded-full bg-blue-500 shadow-[0_2px_40px_rgb(0_0_0_/40%)] transition-shadow duration-[400ms] hover:shadow-blueGlow2"
    >
